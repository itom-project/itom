...
class DataObjectConstructors(unittest.TestCase):
    ...
    def test_constructor_simple(self):
        ...
        # DEFAULT TYPE: UINT8
        # test >= 2D
        shapes = [ (2,100), (1, 1000, 20), (2,50,31),]
        for s in shapes:
            obj1 = dataObject(s)
        ...
        # GIVEN TYPE
        types = ['uint8','int8','uint16','int16', 'int32', 'float32', 'float64', 'complex64', 'complex128', 'rgba32']
    ...
    def test_dtype_conversion_copy_constructor(self):
        ...
        obj4 = dataObject(obj1, dtype='float32') #type cast to float32 should be done (like it is the case for np.ndarray)
