...
def littleendian2int(hexbytes):
    ...
    '''
    if isinstance(hexbytes,int): # if hexbytes is only 1 byte long it is automaticly converted to an integer
        return hexbytes
        ...
        val = int(revhex,16)
        if (val & (1 << (len(hexbytes)*8 - 1))) != 0: # if sign bit is set e.g., 8bit: 128-255
...
class MLJ050:
    def __init__(self):
        ...
        self.dev.setDataCharacteristics(ftd2xx.BITS_8, ftd2xx.STOP_BITS_1, ftd2xx.PARITY_NONE)
        time.sleep(0.05)
        ...
        self.SN = littleendian2int(self.HWinfo[6:10]) # Serial number is given in bytes 7 to 10
        ...
        self.dev.write(bytes.fromhex('13 04 0e 00 d0 01 01 00 00 00 00 00 36 a6 01 00 e0 52 cb 0b'))
        ...
        self.dev.write(bytes.fromhex('16 04 16 00 d0 01 01 00 02 00 00 60 09 00 f7 14 00 00 c6 34 00 00 f4 70 ee 03 02 00'))
        ...
        self.dev.write(bytes.fromhex('23 04 10 00 d0 01 01 00 03 00 03 00 00 40 38 00 00 c0 12 00 01 00'))
        ...
        self.dev.write(bytes.fromhex('40 04 0e 00 d0 01 01 00 02 00 01 00 f4 70 ee 03 00 c0 03 00'))
        ...
        self.dev.write(bytes.fromhex('e6 04 14 00 d0 01 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 02 00'))
        ...
        self.dev.write(bytes.fromhex('13 04 0e 00 d0 01 02 00 00 00 00 00 83 7c 00 00 00 f4 01 00'))
        # set velocity jog parameters
        self.dev.write(bytes.fromhex('16 04 16 00 d0 01 02 00 02 00 00 7d 00 00 00 00 00 00 83 7c 00 00 00 7d 00 00 00 00'))
        #set limit switch parameters
        self.dev.write(bytes.fromhex('23 04 10 00 d0 01 02 00 03 00 01 00 9d ff ff ff 9d ff ff ff 01 00'))
        # set power parameters
        ...
        # set home parameters
        self.dev.write(bytes.fromhex('40 04 0e 00 d0 01 02 00 02 00 01 00 00 7d 00 00 00 32 00 00'))
        ...
        # set joystick parameters
        self.dev.write(bytes.fromhex('e6 04 14 00 d0 01 02 00 4a 0c 02 00 e1 7a 14 00 13 01 00 00 13 01 00 00 01 00'))
