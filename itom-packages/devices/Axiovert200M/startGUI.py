...
# Change MO
for k in range(1, 7):
    mainWin.comBox_MO.call(
        "addItem", (str(k) + ": " + AxioMO[k]["name"])
    )  # index 0-5 = MO 1-6
...
do_init = ui.msgQuestion(
    "Do you want to initialize the Mikroscope?",
    "If you already have initialized the Microscope in the running session you can click NO. Otherwise do the initialization to prevent damage.",
