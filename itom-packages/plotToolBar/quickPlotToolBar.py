...
class quickPlotToolBar(abstractObjInteractionToolBar):
    ...
    def __getVarNameOld(self, title, VarName, objType = '2D'):
        ...
        if len(dObjects) > 0:
            ...
            if len(objindex) > 0:
                ...
                objindex = 0
            [varname, done]= ui.getItem(title, "DataObjects", dObjects, objindex, False)
        else:
    ...
    def show2D(self, skipBox = False, defaultVarName = None, typeFilter = 3):
        ...
        if skipBox == False:
            [dataObj, obtype, check] = self.getVarNameDialog("Choose Object:", dataObj, globals(), 'plane', typeFilter)
        else:
            check = True
    ...
    def show25DOGL(self, dataObj):
        ...
        try:
            ...
            result = 0
            ui.msgCritical("DataObject", "Open GL-Window for 3D-Plot failed", ui.MsgBoxOk)
    ...
    def show25DMPL(self, dataObj):
        ...
        try:
            ...
            ax.plot_surface(X, Y, npdObj, rstride = ystride, cstride = xstride, cmap=cm.jet, linewidth=0, antialiased=False)
    ...
    def show25D(self, skipBox = False, defaultVarName = None):
        ...
        if skipBox == False:
            [dataObj, obtype, check] = self.getVarNameDialog("Choose Object:", dataObj, globals(), 'plane')
        else:
            check = True
    ...
    def show1D(self, skipBox = False, defaultVarName = None, typeFilter = 3):
        ...
        if skipBox == False:
            [dataObj, obtype, check] = self.getVarNameDialog("Choose Object:", dataObj, globals(), 'line', typeFilter)
        else:
            check = True
