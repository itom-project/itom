...
*********************************************************************** */
        ...
        /* Borland/Microsoft */
            ...
            #else
                #ifdef POINTCLOUD_DLL
                    #define POINTCLOUD_EXPORT __export
                #else
                    #define POINTCLOUD_EXPORT /*__import */ /* doesn't exist AFAIK in VC++ */
                #endif                              /* Exists in Borland C++ for
                                                                C++ classes (== huge) */
            #endif
        #endif

        #ifndef POINTCLOUD_EXPORT //POINTCLOUD_EXPORT has not be defined yet
            #ifdef POINTCLOUD_DLL
