...
* Set **Qt_DIR** to to **${MAINDIR}/3rdParty/Qt6.4.1/msvc2016_64/lib/cmake/Qt6**. 
...
* Set the entry **Qt_DIR** to to **${MAINDIR}/3rdParty/Qt5.12.1/msvc2017_64/lib/cmake/Qt5**. 
* Check **VTK_BUILD_QT_DESIGNER_PLUGIN**.

.. note::

    Check the Entries **Qt_DIR**, **QtCore_DIR**, **QtSql_DIR**, ..., 
