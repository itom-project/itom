...
class DoxygenIndexDirective(BaseDirective):
    ...
    def run(self):
        ...
        try:
            myfinder = self.finder_factory.create_finder(project_info)
...
class DoxygenFunctionDirective(BaseDirective):
    ...
    def run(self):
        ...
        try:
            data_object = myfinder.find_one(matcher_stack)
...
class DoxygenFileDirective(BaseDirective):
    ...
    def run(self):
        ...
        matches = []
        myfinder.filter_(finder_filter, matches)
