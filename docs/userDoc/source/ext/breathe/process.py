...
class AutoDoxygenProcessHandle(object):
    ...
    def generate_xml(self, app):
        ...
        for project_name, file_structure in list(app.config.breathe_projects_source.items()):
        ...
        for project_name, data in list(project_files.items()):
    ...
    def process(self, auto_project_info, files):
        ...
        full_paths = [auto_project_info.abs_path_to_source_file(x) for x in files]
