...
- **demoGaussianSpotCentroidDetection.py**
  
  | *Description*: Example how to use the itom.algorithms or itom.filter function using the centroid detection of a gaussianSpot generated by the **DummyGrabber**.