...
at the first line of your script file (iso-8859-15 represents the Western Europe charset). You can also choose **codec...** from the context menu of the editor.
...
possible codecs. For more information see https://www.python.org/dev/peps/pep-0263/.
