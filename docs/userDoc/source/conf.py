...
if "itom_SVN_Rev" in itomVersionInfo and \
        itomVersionInfo["itom_SVN_Rev"] != "":
    release = itomVersionInfo["itom_SVN_Rev"]
elif ("itom_GIT_Rev_Abbrev" in itomVersionInfo and 
      itomVersionInfo["itom_GIT_Rev_Abbrev"] != ""):
...
copyright = f"2011-{compile_year}, Institut fuer Technische Optik (ITO), " \
