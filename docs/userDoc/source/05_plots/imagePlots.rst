...
.. py:attribute:: valueScale : ItomQwtPlotEnums::ScaleEngine 
    ...
    linear or logarithmic scale (various bases) can be chosen for the value axis (color bar). Please consider, that a logarithmic scale can only display values > 1e-100.
