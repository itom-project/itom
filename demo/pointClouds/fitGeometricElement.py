...
if fitGeometry == "line":
    ...
    [cPt, cAxis, cInl] = filter("pclFitLine", cloud, optimizeParameters=0)
    print("The line is at ({}, {}, {}) with the direction ({}, {}, {})".format(cPt[0], cPt[1], cPt[2], cAxis[0], cAxis[1], cAxis[2]))
    ...
    [cPt, cRad, cInl] = filter("pclFitCircle2D", cloud,  [1, 6], optimizeParameters=0)
    ...
    [cPt, cNormal, cRad, cInl] = filter("pclFitCircle3D", cloud,  [1, 6], optimizeParameters=0)
    
    angle = mathe.acos(cNormal[2] / (cNormal[0] * cNormal[0] + cNormal[1] * cNormal[1] + cNormal[2] * cNormal[2])) * 180 / np.pi
    
    angle = np.mod(angle, 90)
    
    print("The circle has a radius {} and a angle of {} and is centered at ({}, {}, {})".format(cRad, angle, cPt[0], cPt[1], cPt[2]))
    ...
    [cPt, cRad, cInl] = filter("pclFitSphere", cloud,  [1, 6], optimizeParameters=0)
    ...
    [cPt, cAxis, cRad, cInl] = filter("pclFitCylinder", pclNorm,  [1, 6], optimizeParameters=0)
    print("The cylinder has a radius {} and its axis is at ({}, {}, {}) with the direction ({}, {}, {})".format(cRad, cPt[0], cPt[1], cPt[2], cAxis[0], cAxis[1], cAxis[2]))
