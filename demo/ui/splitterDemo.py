...
class SplitterDemo(ItomUi): #ListWidgetDemo is inherited from ItomUi
    ...
    def __init__(self): #constructor
        ...
        print("Top section. Collapsible:", self.gui.splitter.call("isCollapsible", 0)) #-> special method call
        print("Bottom section. Collapsible:", self.gui.splitter.call("isCollapsible", 1)) #-> special method call
