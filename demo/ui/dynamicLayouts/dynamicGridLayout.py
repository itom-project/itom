...
class DynamicGridLayout(ItomUi):
    ...
    def __init__(self): #constructor
        ...
        self.gui.comboAddWidget.call(
            "addItems",
            [self.LOAD_FROM_UI, ] + ui.availableWidgets()
        )
    ...
    def on_btnAddWidget_clicked(self):
        ...
        if widget == self.LOAD_FROM_UI:
            filename = ui.getOpenFileName("UI File",
                                          filters="UI Files (*.ui)",
                                          parent=self.gui)
            
            if filename is not None:
                self.layout.call("addItemToGridFromUiFile",
                                 filename,
            ...
            self.layout.call("addItemToGrid",
                             widget,
    ...
    def on_btnColStretch_clicked(self):
        ...
        stretchs = [str(self.layout.call("columnStretch", idx)) 
    ...
    def on_btnRowStretch_clicked(self):
        ...
        stretchs = [str(self.layout.call("rowStretch", idx)) 
