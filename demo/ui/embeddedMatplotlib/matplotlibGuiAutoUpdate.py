...
class MatplotGuiAutoUpdate(ItomUi):
    def __init__(self):
        ItomUi.__init__(self, "matplotlibGuiAutoUpdate.ui", ui.TYPEWINDOW, childOfMainWindow=True, deleteOnClose=True)
        ...
        self.timerID = None
        self.counter = 1
        self.fignum = max([0,] + plt.get_fignums()) + 1 #guarantee to get a new matplotlib figure number
