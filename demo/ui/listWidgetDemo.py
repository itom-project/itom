...
class ListWidgetDemo(ItomUi): #ListWidgetDemo is inherited from ItomUi
    ...
    def on_btnAddItems_clicked(self):
        ...
        flag1 = flagSelectable | flagCheckable | flagEnabled #only checkable with on/off state
        ...
        for i in range(count, count + size):
            ...
            if i % 2 == 0:
                ...
                self.gui.listMain.call("setCheckState", i, checked) #-> special method call
            else:
                self.gui.listMain.call("setFlags", i, flag2) #-> special method call
                self.gui.listMain.call("setCheckState", i, partially) #-> special method call
    ...
    def on_btnEval_clicked(self):
        ...
        for i in range(count):
            ...
            checkState = self.gui.listMain.call("checkState", i)  #-> special method call
            checkStateStr = ["unchecked", "partially", "checked"][checkState]
            print("Item %i: %s, flags: %i, check state: %s" % (i, itemText, itemFlags, checkStateStr))
