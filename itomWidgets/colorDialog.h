...
class ITOMWIDGETS_EXPORT ColorDialog : public QColorDialog
{
  Q_OBJECT
...
public:
  ...
  /// ColorDialog::getColor. \a label is title of the tab and \a signal is the signal fired by
...
//------------------------------------------------------------------------------
void ColorDialog::addTab(QWidget* widget, const QString& label)
{
  this->insertTab(-1, widget, label);
}

//------------------------------------------------------------------------------
void ColorDialog::addDefaultTab(QWidget* widget, const QString& label,
                                   const char* colorSignal,
                                   const char* nameSignal)
{
  ColorDialog::insertDefaultTab(-1, widget, label, colorSignal, nameSignal);
}
