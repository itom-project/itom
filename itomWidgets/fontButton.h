...
/// \ingroup Widgets
class ITOMWIDGETS_EXPORT FontButton: public QPushButton
{
  Q_OBJECT
...
public:
  /// Constructor
  /// Creates a default FontButton initialized with QApplication font
...
protected:
  QScopedPointer<FontButtonPrivate> d_ptr;
