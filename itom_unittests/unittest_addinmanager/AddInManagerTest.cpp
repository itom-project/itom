...
//        goto EXIT;
    ...
    //        if (QMetaObject::invokeMethod(addInMgrInst, "initAddIn", Qt::DirectConnection, Q_ARG(int, pluginNum), Q_ARG(QString, auxPluginName), Q_ARG(ito::AddInDataIO**, &auxCtrl[listID]), Q_ARG(QVector<ito::Param>*, paramsMand), Q_ARG(QVector<ito::Param>*, paramsOpt), Q_ARG(bool, enableAutoLoadParams)))
    retval += addInMgrInst->initAddIn(pluginNum, "DummyMotor", &dummyMot, &paramsMandCpy, &paramsOptCpy, enableAutoLoadParams, NULL);
