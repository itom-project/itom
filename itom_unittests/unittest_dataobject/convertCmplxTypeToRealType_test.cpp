...
/*! \class complexToReal_Test
    ...
    This test converts different complex type variables into different real type variables using
   convertCmplxTypeToRealType(...) method and checks if the method works as desired.
*/
...
TYPED_TEST(complexToReal_Test, convertCmplxTypeToRealType_Test)
{
    ...
    */
    ...
    EXPECT_NE(cmplxType5, ito::convertCmplxTypeToRealType(
                              cmplxType4)); /*!< Testing if two datatype variables do not show equality in result. */
    EXPECT_NE(cmplxType4, ito::convertCmplxTypeToRealType(
                              cmplxType1)); /*!< Testing if two datatype variables do not show equality in result. */
    ...
    EXPECT_EQ(
        ...
        ito::convertCmplxTypeToRealType(
            cmplxType8)); /*!< Testing if the function returns ito::tFloat32 type for ito::tComplex64 type variable. */
    EXPECT_EQ(
        cmplxType7,
        ito::convertCmplxTypeToRealType(
            cmplxType9)); /*!< Testing if the function returns ito::tFloat64 type for ito::tComplex128 type variable. */
}
