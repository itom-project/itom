...
template <typename _Tp> class dataTest : public ::testing::Test
{
  public:
    ...
    {
      public:
        MatrixContainer(int nrOfDimensions, int dim1, int dim2, int dim3 = 0, int dim4 = 0)
            : m_dim1(dim1), m_dim2(dim2), m_dim3(dim3), m_dim4(dim4), m_nrOfDimensions(nrOfDimensions)
        {
    ...
    {
      public:
        MatrixContainer2(int nrOfDimensions, int dim1, int dim2, int dim3 = 0, int dim4 = 0)
            : m_dim1(dim1), m_dim2(dim2), m_dim3(dim3), m_dim4(dim4), m_nrOfDimensions(nrOfDimensions)
        {
            matrix = ito::DataObject();
            switch (nrOfDimensions)
...
// checkZeros
/*!
    This test checks functionality of "zeros" method for 1, 2 and 3 dimensional matrices by checking if the required
...
// checkOnes
/*!
    This test checks functionality of "ones" method for 2 and 3 dimensional matrices by checking if the required matrix
   is filled with Ones.
*/
