...
/*! \class getDataTypetest
    ...
    This test contains 2 test cases for getDataType and getDataType2 functions each and checks the outputs of them when
   they are applied with respective data types.
*/
