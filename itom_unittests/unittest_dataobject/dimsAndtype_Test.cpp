...
TYPED_TEST(DimAndTypeTest, getDims_Test)
{
    ...
    EXPECT_EQ(0,this->dObj1.getDims() );        //!< checking dimensions of empty data object using getDims() function which should return 0
    EXPECT_EQ(2,this->dObj2.getDims() );        //!< checking dimensions of 1 dimensional data object using getDims() function which should return value 2 because there is no existance of 1 dimensional data object and if they are defined, they should be taken as 2 dimensional data object automatically.
    EXPECT_EQ(2,this->dObj3.getDims() );        //!< checking dimensions of 2 dimensional data object using getDims() function which should return value 2
    EXPECT_EQ(3,this->dObj4.getDims() );        //!< checking dimensions of 3 dimensional data object using getDims() function which should return value 3
    EXPECT_EQ(5,this->dObj5.getDims() );        //!< checking dimensions of 5 dimensional data object using getDims() function which should return value 5
}
