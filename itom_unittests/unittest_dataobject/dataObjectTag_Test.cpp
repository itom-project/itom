...
TYPED_TEST(dataObjectTag_Test,set_getAxisDescription_Test1d)
{
    ...
    bool vop;
    std::string AxisDescrip = this->mat1_1d.getAxisDescription(0,vop); //retrive the given axis description by "getAxisDescription" function for Axis0
...
{
    EXPECT_GT(this->mat1_3d.setAxisDescription(-1,"X-Axis ---> Height"),0);                //Here the Axis index value is given negative which is wrong.
...
{    
    ...
    bool test1 = this->mat1_1d.getTagByIndex(0,key1,value1_);        //get the key1 and value1 of mat1_1d by index value using "getTagByIndex" function
    bool test2 = this->mat1_1d.getTagByIndex(1,key2,value2_);        //get the key2 and value2 of mat1_1d by index value using "getTagByIndex" function
