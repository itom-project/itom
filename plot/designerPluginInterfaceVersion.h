...
#define ITOM_DESIGNERPLUGININTERFACE_MINOR 0 //change this number below as well (1x)
#define ITOM_DESIGNERPLUGININTERFACE_PATCH 0 //change this number below as well (1x)
...
#define ITOM_DESIGNERPLUGININTERFACE_VERSION_STR CREATE_DESIGNERPLUGININTERFACE_VERSION_STR(2,0,0)
