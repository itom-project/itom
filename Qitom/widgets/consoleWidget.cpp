...
RetVal ConsoleWidget::execCommand(int beginLine, int endLine)
{
    ...
    else
    {
        ...
        QList<int> lines = pyEng->parseAndSplitCommandInMainComponents(singleLine.toUtf8().data(), encoding); //clc command will be accepted and parsed as single command -> this leads to our desired behaviour
